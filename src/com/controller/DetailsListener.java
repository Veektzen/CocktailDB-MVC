...
public class DetailsListener implements MouseListener {
    String id;
    ...
    /**
     * This actionlistener will display a dialog with the details of the cocktail
     * @param e
     */
    @Override
    public void mouseClicked(MouseEvent e) {
        Singleton instance = Singleton.getInstance();
        JSONArray jsonArray = instance.getCocktailR().getCocktailDetails(id);
