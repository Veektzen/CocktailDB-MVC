...
public class CocktailRepository extends GenericRepository<Cocktail> implements ICocktailRepository {
    ...
    /**
     * this method returns the cocktail list from API
     *
     * @return cocktails
     */
    @Override
    ...
    /**
     * This method returns details for cocktails
     *
     * @param id
     * @return
     */
